...
export const VentaScreen = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (
      ...
      (montoMinimo.length > 0 && montoMaximo.length > 0)
    ) {
      axios
        .post("http://localhost:9000/Ventas", formValues)
        .then((response) => {
  ...
  const getDatos = (id, total, e) => {
    ...
    axios
      .post("http://localhost:9000/VentasDetalle/", id)
      .then((response) => {
  ...
  const getDatosCliente = (id, e) => {
    ...
    axios
      .post("http://localhost:9000/ClienteDetalle/", id)
      .then((response) => {
        const datosC = response.data;
  ...
  const getDatosProducto = (id, e) => {
    ...
    axios
      .post("http://localhost:9000/InventarioDetalle/", id)
      .then((response) => {
        const datosC = response.data;
  ...
  return (
    <div className="container">
            ...
            <div className="form-group col-md-3">
              <div className="input-group">
                <div className="input-group-prepend">
                  <span className="input-group-text" id="inputGroupPrependnumF">
                    <strong>Del:</strong>
                  </span>
                </div>
                <input
            ...
            <tr>
              ...
              <td>
                <button
                  ...
                  role="link"
                  onClick={(e) => getDatosCliente(sell.CustomerID, e)}
                  data-toggle="modal"
                  data-target=".bd-clienteInfo-modal-lg"
                >
                  {sell.CustomerName}
                </button>
              </td>
                        ...
                        <table>
                          <tbody>
                            {datos.slice(0, 1).map((data) => (
                              <tr>
                                <td>
                                  Método Entrega: {data.DeliveryMethodName}
                                  <br />
                      ...
                      <tr className="item">
                        <td>
                          <button
                            ...
                            role="link"
                            onClick={(e) =>
                              getDatosProducto(data.StockItemID, e)
                            }
                            data-toggle="modal"
                            data-target=".bd-productoInfo-modal-lg"
                          >
                            {data.StockItemName}
                          </button>
                        </td>
      ...
      <div
        className="modal fade bd-clienteInfo-modal-lg"
        tabIndex="-1"
        role="dialog"
        aria-labelledby="myLargeModalLabel"
        aria-hidden="true"
          ...
          <div className="modal-content">
            <div className="modal-header">
              ...
              {datosCliente.map((data) => (
                <h5 key="clienteName" className="modal-title">
                  {data.CustomerName}
                </h5>
              ))}
              <button
              ...
              {datosCliente.map((data) => (
                <div>
                  <div className="form-row">
                    ...
                    <div className="form-group col-md-4">
                      <label htmlFor="Fax" className="col-form-label">
                        <b>Fax:</b>
                      </label>
                  ...
                  <div className="form-row">
                    ...
                    <div className="form-group col-md-4">
                      ...
                      <p id="Sitioweb">
                        <a id="telefono" href={data.WebsiteURL}>
                          {data.WebsiteURL}
                        </a>
                      </p>
                    </div>
      ...
      <div
        className="modal fade  bd-productoInfo-modal-lg"
        tabIndex="-1"
        role="dialog"
        aria-labelledby="myLargeModalLabel"
        aria-hidden="true"
              ...
              {datosProducto.map((data) => (
                <div>
                  <div className="form-row">
                    ...
                    <div className="form-group col-md-4">
                      <label htmlFor="ColorName" className="col-form-label">
                        <b>Color:</b>
                      </label>
                    ...
                    <div className="form-group col-md-4">
                      <label
                        htmlFor="Unidad de empaquetamiento"
                        className="col-form-label"
                      >
                        <b>Unidad de empaquetamiento:</b>
                      </label>
                  ...
                  <div className="form-row">
                    ...
                    <div className="form-group col-md-4">
                      ...
                      <p id="Precio venta">
                        {currencyFormat(data.RecommendedRetailPrice)}
                      </p>
                    </div>
                    <div className="form-group col-md-4">
                      <label htmlFor="telefono" className="col-form-label">
                  ...
                  <div className="form-row">
                    ...
                    <div className="form-group col-md-4">
                      <label
                        htmlFor="Cantidad de empaquetamiento"
                        className="col-form-label"
                      >
                  ...
                  <div className="form-row">
                    <div className="form-group col-md-4">
                      <label htmlFor="tallas" className="col-form-label">
                        <b>Tallas / tamaño:</b>
                      </label>
                      <p id="tallas">{data.Size}</p>
                    </div>
                    <div className="form-group col-md-4">
                      <label htmlFor="Impuesto" className="col-form-label">
                        <b>Impuesto:</b>
                      </label>
                  ...
                  <div className="form-row">
                    ...
                    <div className="form-group col-md-4">
                      <label htmlFor="BinLocation" className="col-form-label">
                        <b>Ubicación:</b>
                      </label>
